# Generated by Django 4.2.3 on 2023-10-20 20:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.datetime(2023, 10, 20, 23, 24, 49, 685117))),
                ('component', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='studio_app.component')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.FloatField()),
                ('description', models.CharField(blank=True, max_length=1000, null=True)),
                ('date', models.DateField(default=datetime.datetime(2023, 10, 20, 23, 24, 49, 684120))),
                ('lab', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='studio_app.lab')),
